    ...
    return (
        <>
            <div className="bg-gray-900 h-screen flex flex-col justify-center flex-wrap items-center">
                ...
                <div>
                    <p onClick={handleClick} className={`absolute bottom-5 mt-4 transform -translate-x-1/2 bg-[#00CCFF] font-bold text-lg text-white px-6 py-2 rounded-full hover:bg-[#3e92e6] hover:scale-105   transition-all duration-1000 
